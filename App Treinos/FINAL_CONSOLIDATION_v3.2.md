# App Treinos v3.2 — Consolidação Final
...
- **Estrutura:**
  1. Bem-vindo ao App Treinos (apresentação)
...
- **Estrutura (4 subsecções expandíveis):**
  ...
  4. **Suporte**
     - Email: support@apptreinos.com.br
     - FAQ com 4 respostas
...
4. Compilar executável AppTreinos.exe v3.2
