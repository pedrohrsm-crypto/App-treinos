"""
Sistema de Banco de Dados - Velix
========================================
...
class DatabaseManager:
    ...
    def _connect_mysql(self):
        ...
        try:
            self.connection = self.mysql_connector.connect(
                ...
                database=os.environ.get("DB_NAME", "velix"),
            )
            self._init_mysql_db()
    ...
    def _init_mysql_db(self):
        ...
        cursor.execute("CREATE DATABASE IF NOT EXISTS velix")
        cursor.execute("USE velix")
