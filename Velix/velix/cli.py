...
class CLIManager:
    ...
    def run_app(self) -> int:
        ...
        """
        try:
            print(f"[INIT] Iniciando Velix v{self.config.version}")
    ...
    def build_exe(self) -> int:
        ...
        try:
            ...
            if result.returncode == 0:
                exe_path = self.project_root / "dist" / "Velix.exe"
                print()
    ...
    def build_installer(self) -> int:
        ...
        try:
            ...
            if result.returncode == 0:
                setup_exe = self.project_root / "Output" / "Velix_Setup.exe"
                print()
    ...
    def show_version(self) -> int:
        ...
        print(f"Velix v{self.config.version}")
        return 0
