...
Resultado:
    dist/Velix.exe (executável standalone)
"""
...
def build_executable():
    ...
    print("[BUILD] Compilando Velix v3.2.0...")
    print()
    ...
    pyinstaller_args = [
        ...
        "--workpath=build",
        "--specpath=.",
        str(project_root / "velix" / "__main__.py"),
    ]
    ...
    try:
        ...
        if result.returncode == 0:
            exe_path = project_root / "dist" / "Velix.exe"
            if exe_path.exists():
